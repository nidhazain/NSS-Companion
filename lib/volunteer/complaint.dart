...
class _ComplaintPageState extends State<ComplaintPage> {
  ...
  final comctr=TextEditingController();
                             ...
                             Container(
                               ...
                               child: Center(
                                 child: TextButton(onPressed:(()async {
                                  if(st!=null){
                                        if(namectr.text.isNotEmpty && comctr.text.isNotEmpty && dtectr.text.isNotEmpty ){
                                          fb.collection("complaint").doc().set({
                                            'program/camp name':namectr.text,
                                            'complaint':comctr.text,
                                            'date':dtectr.text,
                                          });
                                        }
                                       }
