...
import 'package:project_nss/po/widgets/program0_card.dart';
import 'package:project_nss/volunteer/widgets/program_card_2.dart';
class program0page extends StatelessWidget {
  const program0page({super.key});
          ...
          children: List.generate(snapshot.data!.docs.length, (index) {
             DocumentSnapshot document = snapshot.data!.docs[index];
              return Padding(
                ...
                child: program0card(index: index,myDoc: document)
              );
            },),
        ),
        ),
