...
class _ProgramsPageState extends State<ProgramsPage> {
  ...
  final tymctr=TextEditingController();
                             ...
                             Container(
                               ...
                               child: Center(
                                 child: TextButton(onPressed:(() async{
                                   if(po!=null){
                                        if(pnamectr.text.isNotEmpty && plcctr.text.isNotEmpty && dtectr.text.isNotEmpty && tymctr.text.isNotEmpty && descctr.text.isNotEmpty ){
