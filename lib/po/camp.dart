...
class _CampPageState extends State<CampPage> {
  ...
  final plcctr=TextEditingController();
  final fdtectr=TextEditingController();
  final tdtectr=TextEditingController();
                             ...
                             Container(
                               ...
                               child: Center(
                                 child: TextButton(onPressed:(()async {
                                  if(po!=null){
                                        if(cnamectr.text.isNotEmpty && plcctr.text.isNotEmpty && fdtectr.text.isNotEmpty && tdtectr.text.isNotEmpty && descctr.text.isNotEmpty ){
                                          fb.collection("camp_details").doc().set({
                                            'camp name':cnamectr.text,
                                            'place':plcctr.text,
                                            'from date':fdtectr.text,
                                            'to date':tdtectr.text,
