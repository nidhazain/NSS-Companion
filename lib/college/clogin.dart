...
import 'package:project_nss/college/cregister.dart';
...
class cloginscreen extends StatelessWidget {
                    ...
                    Padding(
                      ...
                      child: Column(
                        children:const <Widget>[
                          Text("COLLEGE LOGIN" , style: TextStyle(color: Colors.white, fontSize: 30,fontFamily: "Century Gothic"),),
                          SizedBox(height: 10,),
                             ...
                             Row(
                               ...
                               children: [
                                 TextButton(onPressed: (){
                                   Navigator.push(context, MaterialPageRoute(builder: (ctx) => CRegister(),),);
                               ...
                               children: <Widget>[
                                 ...
                                 Expanded(
                                   child: Container(
                                     ...
                                     child: Center(
                                       child: TextButton(onPressed: (){
                                         Navigator.pushReplacement(context, MaterialPageRoute(builder: (ctx) => vloginscreen() ,),);
                                       }, 
 ...
 void checkLogin(BuildContext ctx){
  ...
  {
    Navigator.of(ctx).pushReplacement(MaterialPageRoute(builder: (ctx1) =>const  cHomescreen(),),);

  }else{
    final _errorMessage = "userGname password doesn't match";
