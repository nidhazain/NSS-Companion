                      ...
                      Padding(
                        ...
                        child: Column(
                          children:const <Widget>[
                            Text("College" , style: TextStyle(color: Colors.white, fontSize: 20,fontFamily: "Century Gothic"),),
                            Text("Create Account" , style: TextStyle(color: Colors.white, fontSize: 40,fontFamily: "Century Gothic"),),
                          ],
                        ),
                      ),
                               ...
                               child: Column(
                                ...
                                Container(
                                 ...
                                 Row(
                                   ...
                                   children: [
                                     TextButton(onPressed: (){}, child:const Text("Already have an account? Login",style: TextStyle(color: Colors.grey,fontFamily: "Century Gothic"),),)
                                   ],
